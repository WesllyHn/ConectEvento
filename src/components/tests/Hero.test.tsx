...
describe('Hero', () => {
  ...
  it('should render hero section with correct heading', () => {
    ...
    expect(screen.getByText(/Encontre os melhores/i)).toBeInTheDocument();
    const fornecedoresElements = screen.getAllByText(/fornecedores/i);
    expect(fornecedoresElements.length).toBeGreaterThan(0);
    expect(screen.getByText(/para o seu evento/i)).toBeInTheDocument();
  });
  ...
  it('should render subtitle correctly', () => {
    ...
    expect(
      screen.getByText(/Conecte-se com profissionais qualificados/i)
    ).toBeInTheDocument();
  });
  ...
  it('should render search input with correct placeholder', () => {
    ...
    const searchInput = screen.getByPlaceholderText(/Tipo de serviço/i);
  ...
  it('should render location input with correct placeholder', () => {
    ...
    const locationInput = screen.getByPlaceholderText(/Cidade ou região/i);
  ...
  it('should render budget select with all options', () => {
    ...
    expect(screen.getByText('Qualquer orçamento')).toBeInTheDocument();
  ...
  it('should render search button', () => {
    ...
    const searchButton = screen.getByText('Buscar Fornecedores');
  ...
  it('should navigate with search params when form is submitted', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=buffet&location=São Paulo');
  });
  ...
  it('should navigate with empty params when form is submitted without filling inputs', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=&location=');
  });
  ...
  expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=DJ&location=');
});
  ...
  it('should navigate with only location when search query is empty', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=&location=Rio de Janeiro');
  });
  ...
  it('should submit form when pressing Enter in search input', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=decoração&location=');
  });
  ...
  it('should submit form when pressing Enter in location input', async () => {
    ...
    expect(mockNavigate).toHaveBeenCalledWith('/suppliers?search=&location=Curitiba');
  });
